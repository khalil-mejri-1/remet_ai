...
const KeySessions = () => {
  ...
  const fetchSessions = async () => {
    ...
    try {
      ...
      const res = await axios.get("http://localhost:3000/api/KeySession");
  ...
  const handleSave = async (e) => {
    ...
    try {
      if (currentSession._id) {
        ...
        // Assuming API_URL is 'http://localhost:3000/api', then the endpoint should be `${API_URL}/KeySession`
